...
# MODEL_PATH = r"D:\Users\gxy\every_thing\project\vs_chatglm\ChatGLM3\models\chatglm3-6b"

MODEL_PATH = "D:\\Users\\gxy\\every_thing\\project\\vs_chatglm\\ChatGLM3\\models\\chatglm3-6b"
# MODEL_PATH = os.environ.get('MODEL_PATH', 'D:\\Users\\gxy\\every_thing\\project\\vs_chatglm\\output\\checkpoint-3000')

# MODEL_PATH = "D:/Users/gxy/every_thing/project/vs_chatglm/output/checkpoint-1500"

PT_PATH = os.environ.get('PT_PATH', None )

# PT_PATH = os.environ.get('PT_PATH', 'D:\\Users\\gxy\\every_thing\\project\\vs_chatglm\output\\checkpoint-1500')
    ...
    def __init__(self, model_path: str, tokenizer_path: str, pt_checkpoint: str = None):
        ...
        if pt_checkpoint is not None and os.path.exists(pt_checkpoint):
            ...
            self.model = AutoModel.from_pretrained(
                ...
                config=config).quantize(bits=4, device="cuda").cuda().eval()
            ...
            # prefix_state_dict = torch.load(os.path.join(pt_checkpoint, "training_args.bin"))

            new_prefix_state_dict = {}

            # print('!!!!!!')
            # print(type(prefix_state_dict))
